#\!/usr/bin/env python3
"""
Create ProductCategoryProduct records for Add-On products with correct category ID.
"""
...
def main():
    ...
    # Correct Add-Ons category ID
    addon_category_id = '0ZGdp00000007JGGAY'  # Add-Ons
    
    print(f"\nCreating assignments for {len(addon_products)} Add-On products:")
    print(f"Category: Add-Ons ({addon_category_id})")
